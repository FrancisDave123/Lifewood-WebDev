          ...
          <div className="relative z-10 mx-auto max-w-6xl space-y-5">
            ...
            <div className="rounded-3xl border border-lifewood-serpent/10 bg-white p-5 shadow-[0_16px_50px_rgba(19,48,32,0.08)]">
              ...
              <p className="mt-2 text-sm text-lifewood-serpent/65">
                Export applicant data directly from the database into an Excel report.
              </p>
              ...
              <div className="mt-5">
                <div className="rounded-2xl border border-lifewood-serpent/10 bg-lifewood-seaSalt/60 p-5">
                  ...
                  <div className="mt-4 rounded-xl border border-lifewood-green/20 bg-white p-4">
                    <p className="mb-2 text-xs font-semibold uppercase tracking-[0.12em] text-lifewood-serpent/60">Report Format</p>
                    <div className="inline-flex items-center gap-2 rounded-xl border border-lifewood-green/20 bg-lifewood-green/5 px-4 py-2.5 text-sm font-semibold text-lifewood-serpent">
                  ...
                  <div className="mt-4 rounded-xl border border-lifewood-green/20 bg-white p-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={sheet}
                          className="inline-flex items-center rounded-full bg-lifewood-green/10 px-3 py-1 text-xs font-semibold text-lifewood-green"
                        >
                          {sheet}
                        </span>
                      ))}
